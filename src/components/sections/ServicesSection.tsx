    ...
    items: [
      {
        ...
        href: "/motor-repair-pattukkottai",
      },
      {
        name: "Fan Repair",
      ...
      },
      {
        ...
        href: "/mixer-grinder-service-pattukkottai",
      },
      {
        ...
        href: "/submersible-pump-repair-pattukkottai",
      },
      {
        name: "Water Motor Repair",
        desc: "Domestic and agricultural water motor service.",
        icon: <FiActivity />,
        image: "/images/motor.png",
        href: "/water-motor-repair-pattukkottai",
      }
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/mixie-spares-pattukkottai",
      },
      {
        name: "Electrical Spares",
        desc: "Genuine spare parts for all electrical appliances.",
        icon: <FiShoppingCart />,
        image: "/images/motor_spare_parts.png",
        href: "/electrical-spare-parts-pattukkottai",
      },
      {
        name: "Fan Spares",
                ...
                {category.items.map((item, itemIdx) => {
                  const CardContent = (
                    <motion.div
                      ...
                      className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 overflow-hidden flex flex-col group h-full"
                    >
                      {item.image && (
                  ...
                  return item.href ? (
                    <Link href={item.href} key={itemIdx} className="block h-full cursor-pointer">
                      {CardContent}
                    </Link>
                  ) : (
                    <div key={itemIdx} className="block h-full">
                      {CardContent}
                    </div>
                  );
                })}
