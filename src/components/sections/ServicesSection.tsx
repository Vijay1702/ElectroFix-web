...
const categories = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Mixer Grinder Spares",
        desc: "Jars, blades, couplers, carbon brushes, and rotary switches.",
        icon: <FiShoppingCart />,
        image: "/images/mixer_spare_parts.png",
      },
      {
        name: "Motor Spares",
        desc: "Impellers, copper coils, mechanical seals, and bearings.",
        icon: <FiShoppingCart />,
        image: "/images/motor_spare_parts.png",
      },
      {
        name: "Fan Spares",
        desc: "Stators, blades, downrods, capacitors, and bearings.",
        icon: <FiShoppingCart />,
        image: "/images/fan_spare_parts.png",
      },
      {
        name: "Genuine Spare Parts",
        desc: "Motors, blades, wires, switches, and more.",
        icon: <FiShoppingCart />,
        image: "/images/product_spares.png",
      },
    ],
  },
];
